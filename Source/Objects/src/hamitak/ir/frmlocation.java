...
public class frmlocation extends Activity implements B4AActivity{
	public static frmlocation mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "hamitak.ir", "hamitak.ir.frmlocation");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (frmlocation).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "hamitak.ir", "hamitak.ir.frmlocation");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "hamitak.ir.frmlocation", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (frmlocation) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (frmlocation) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (frmlocation) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="Activity.LoadLayout(\"FrmLocation\")";
mostCurrent._activity.LoadLayout("FrmLocation",mostCurrent.activityBA);
 //BA.debugLineNum = 23;BA.debugLine="Spinner1.Add(\"آذربایجان غربی\")";
mostCurrent._spinner1.Add("آذربایجان غربی");
 //BA.debugLineNum = 24;BA.debugLine="Spinner2.Add(\"شاهین دژ\")";
mostCurrent._spinner2.Add("شاهین دژ");
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 15;BA.debugLine="Private Spinner1 As Spinner";
mostCurrent._spinner1 = new anywheresoftware.b4a.objects.SpinnerWrapper();
 //BA.debugLineNum = 16;BA.debugLine="Private Spinner2 As Spinner";
