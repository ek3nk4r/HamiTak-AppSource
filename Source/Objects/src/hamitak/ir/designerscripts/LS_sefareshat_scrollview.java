...
public class LS_sefareshat_scrollview{
...
views.get("imageview4").vw.setTop((int)((views.get("panel4").vw.getTop() + views.get("panel4").vw.getHeight()/2)-(11d * scale) - (views.get("imageview4").vw.getHeight() / 2)));
...
views.get("lbl_peygiri").vw.setWidth((int)((85d / 100 * width)));
views.get("lbl_peygiri").vw.setTop((int)((views.get("panel4").vw.getTop() + views.get("panel4").vw.getHeight())-(3d * scale) - (views.get("lbl_peygiri").vw.getHeight())));
views.get("lbl_peygiri").vw.setLeft((int)((views.get("panel4").vw.getLeft() + views.get("panel4").vw.getWidth()/2) - (views.get("lbl_peygiri").vw.getWidth() / 2)));
