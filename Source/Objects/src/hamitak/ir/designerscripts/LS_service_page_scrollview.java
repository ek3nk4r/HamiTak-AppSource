...
public class LS_service_page_scrollview{
...
views.get("imageview4").vw.setLeft((int)((views.get("panel4").vw.getLeft() + views.get("panel4").vw.getWidth())-(15d * scale) - (views.get("imageview4").vw.getWidth())));
...
views.get("label50").vw.setLeft((int)((views.get("imageview4").vw.getLeft())-(15d * scale) - (views.get("label50").vw.getWidth())));
